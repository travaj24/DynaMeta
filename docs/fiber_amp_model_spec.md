...
## 16. Er:Yb explicit 4I11/2 level and the Yb emission cross-section scale
...
v0.11.2 bit for bit -- asserted in one process (`tests/test_fiber_eryb_4i11_2.py`, gate 1).
