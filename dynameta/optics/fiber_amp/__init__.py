...
physics, and neither is reachable from the solvers -- nothing below them imports them):
  ...
  Phase 23 march_ase              : the OPT-IN self-consistent (ASE-coupled) transient step --
           ...
           docs/audit/2026-09-15-march-self-consistent-ase.md and model spec sec.17.
...
__all__ = ["ASE_MODES", "SelfConsistentControl", "StepReport",
           ...
           "TransientResult", "simulate_transient", "simulate_transient_eryb",
