...
repo is a deliberate follow-on, not part of the map. This engine implements the 'x'/'y' SUBSET
(normal incidence: no plane of incidence, so no distinct p-pol mode).
"""
